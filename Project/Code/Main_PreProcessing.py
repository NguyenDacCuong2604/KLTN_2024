...
if __name__ == "__main__":
    ...
    vietnameseTextPreprocessorStopwordsVietnamese = VietnameseTextPreprocessor(path_stopwords=path_stopwords_vietnamese, remove_np=False)
    ...
    vietnameseTextPreprocessorStopwordsProject = VietnameseTextPreprocessor(path_stopwords=path_stopwords_project)
